...
http.createServer((req,res)=>{
 const u=new URL(req.url,'http://localhost'),routes={'/public/widget-renderer.js':'public/vendor/penecho-dom-renderer.js','/public/sequence-runtime.js':'public/vendor/sequence-runtime.js','/public/architecture-runtime.js':'public/vendor/architecture-runtime.js','/public/architecture-worker.js':'public/vendor/architecture-worker.js'};
...
}).listen(8767,'127.0.0.1',()=>console.log('Sequence sandbox harness http://127.0.0.1:8767'));
