// Archify 2.17 MIT: SVG sigils and text measurement only. Viewer/template/i18n omitted.
const ESCAPE_MAP = { '&': '&amp;', '<': '&lt;', '>': '&gt;', '"': '&quot;', "'": '&#39;' };
export function esc(value) { return String(value ?? '').replace(/[&<>"']/g, character => ESCAPE_MAP[character]); }
