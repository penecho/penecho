...
| `PENECHO_CANVAS_AGENT_AUTO_OPEN` | Open Canvas Agent whenever a canvas opens; defaults to `true`, including for existing users whose configuration does not contain this setting |
