...
- **Более быстрый и гибкий Refine.** Напишите указания в любом месте видимой области и выберите изменяемый виджет. Стандартный unified diff передаёт только изменения, сокращая расход токенов и ожидание, сохраняя подтверждение и отмену.
