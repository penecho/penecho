...
- **PenEcho Cloud.** Приватные проекты на разных устройствах, синхронизация избранного и управление учётной записью, хранилищем и кредитами.
- **Связанное устройство.** Подключите этот хост одноразовым ключом и открывайте его из авторизованных браузеров и приложений; связь можно приостановить, возобновить или удалить.
- **Echoes и публичные Crafts.** Находите, публикуйте и повторно используйте публичные холсты и виджеты с категориями, избранным и веб-просмотрщиком только для чтения.
- **Безопасное сохранение между устройствами.** Каждое сохранение создаёт неизменяемую ревизию; изменения с другого устройства никогда не перезаписываются незаметно.
