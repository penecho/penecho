...
- **Canvas Agent: от источников к визуальному результату.** Добавляйте папки и файлы только для чтения — PDF, Word, PowerPoint, Excel, изображения или код, — объединяйте их с веб-исследованием и текущим холстом и поручайте одному агенту анализ, планирование, создание и доработку.
...
- **Canvas Agent.** Работайте с локальными файлами, проектами папок только для чтения, веб-исследованием, контекстом холста, визуальным созданием и прямым редактированием в одном многошаговом процессе.
- **Visual Explorer.** Превращайте исследования, документы, заметки и планы в адаптивный визуальный результат, связывающий обзор, детали и доказательства.
- **Меньше переключений и повторной работы.** Исследуйте, анализируйте, структурируйте, визуализируйте, проверяйте и дорабатывайте в одном пространстве; результат остаётся редактируемым на холсте.
- **Постепенная визуальная доставка.** Получайте полные версии Visual Explorer раньше и дорабатывайте их на месте, не создавая всё заново.
- **Больше рабочего контекста.** Добавляйте PDF, Word, PowerPoint, Excel, изображения, код, папки только для чтения, существующие Widgets и рукописный ввод; используйте интернет-поиск, когда он доступен.
